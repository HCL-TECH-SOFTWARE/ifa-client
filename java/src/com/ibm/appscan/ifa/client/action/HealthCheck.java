...
public class HealthCheck extends IfaAction{

	public HealthCheck(boolean allow_self_signed, ArrayList<String> hosts)
	...
	public String getHealth() throws IfaClientException{
		try {
